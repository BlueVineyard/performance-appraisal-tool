<x-layouts.auth.split>
    <div class="flex flex-col">
        <h1 class="text-3xl font-semibold leading-[120%] tracking-normal font-dm-sans text-black">Welcome back!</h1>

        <hr class="w-full border-dashed my-7">
        ...
        <div class="grid gap-6">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div class="form-group space-y-2">
                    <label for="email" class="text-base font-semibold leading-[130%] font-dm-sans block">E-mail</label>
                    <input type="email" id="email" name="email"
                        class="bg-[#F3F3F6] w-full px-6 py-4 text-sm font-dm-sans leading-[160%] rounded-2xl outline-0"
                        placeholder="Daviduram@gmail.com" required autofocus />
                </div>
                ...
                <a href="{{ route('password.request') }}"
                    class="text-base font-semibold leading-[130%] font-dm-sans block hover:text-primary text-right">Forgot
                    password?</a>
            ...
            <div class="text-center text-sm">
                ...
                <a href="{{ route('register') }}" class="font-semibold font-dm-sans">Register</a>
            </div>
        </div>
    </div>
</x-layouts.auth.split>